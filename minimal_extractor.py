"""
Minimal Document Information Extraction System
Works without conflicting dependencies
"""
...
# Try to import optional dependencies, fall back to basic functionality
try:
    import cv2
    import numpy as np
...
try:
    ...
    PIL_AVAILABLE = False
    print("Pillow not available - image processing disabled")
...
class MinimalDocumentProcessor:
    """Minimal document processor that works with basic dependencies"""
    ...
    def __init__(self):
        ...
        self.name_patterns = [
            ...
            re.compile(r'Child\'s Name:\s*([A-Z][a-z]+(?:\s+[A-Z][a-z]+)+)', re.IGNORECASE)
        ]
    ...
    def extract_text_from_file(self, file_path: str) -> str:
        ...
        if file_path.suffix.lower() == '.pdf':
            return self.extract_text_pdf(str(file_path))
        elif file_path.suffix.lower() in ['.txt']:
            return self.extract_text_txt(str(file_path))
        else:
            return self.extract_text_image(str(file_path))
    ...
    def extract_text_image(self, file_path: str) -> str:
        ...
        if not TESSERACT_AVAILABLE or not PIL_AVAILABLE:
            print("Image processing not available - install pytesseract and Pillow")
            return ""
...
def main():
    ...
    print("Minimal AI Document Information Extraction System")
    print("=" * 60)
